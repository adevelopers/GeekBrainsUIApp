...
extension User {
    static let items = [
        ...
        User(id: "6", firstName: "Захар", lastName: "", email: "zevs@mail.ru", phone: "+7 903 000-00-00", avatar: "zahar", sex: .male, location: "Москва"),
        User(id: "7", firstName: "Дарья", lastName: "Грач", email: "daria.grach@mail.ru", phone: "+7 903 000-00-00", avatar: "", sex: .female, location: "Москва"),
